...
def createWebpage(lstm, filename, maxChars=10000):
...
try:
	...
	lstm = buildNetwork(256, 5, 257, hiddenclass=LSTMLayer, outputbias=False,
		recurrent=True)
...
trainer = RPropMinusTrainer(lstm, dataset=ds)
